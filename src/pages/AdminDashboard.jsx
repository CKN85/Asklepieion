  ...
  return (
    <div className="min-h-screen bg-[#0E0C09] text-[#E2DED0]">
      ...
      <div className="max-w-5xl mx-auto px-8 py-16">
        <div className="mb-12">
          <div className="label-caps text-[#C9A84C] text-[9px] tracking-[0.3em] mb-3">The Scribe's Chamber</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#1A1815] mb-12">
          {statCards.map(card => (
            <Link key={card.label} to={card.to} className="bg-[#0E0C09] p-6 group hover:bg-[#0f0d0a] transition-colors">
              ...
              <div className="font-heading text-3xl font-light text-[#E2DED0] group-hover:text-[#C9A84C] transition-colors">
                {loading ? '—' : card.value}
              </div>
            </Link>
          ))}
        ...
        <div>
          <div className="label-caps text-[#C9A84C] text-[9px] tracking-[0.25em] mb-6">Recently Updated</div>
